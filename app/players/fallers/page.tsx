    ...
    <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-10">
      <header className="mb-6">
        ...
        <p className="mt-2 text-sm text-slate-600">
          Largest estimated standing decreases from {priorSeason} → {currentSeason}.
        </p>
      </header>
        ...
        <div className="divide-y divide-slate-200">
          {top.map((m) => (
            <div key={m.player.id} className="grid grid-cols-12 items-center gap-3 px-6 py-4">
              ...
              <div className="col-span-3 sm:col-span-1 text-right text-sm font-semibold text-red-700">
                {formatDelta(m.delta)}
              </div>
